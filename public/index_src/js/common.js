...
//手机端的ajax的post方法
    ...
    "ajax_jsonp_mobile": function (url, param, async, success) {
    ...
    //ajax的JSONP_post方法
    "ajax_jsonp1": function (url, param, success, loading, show_model) {
        console.log(url, param, success, loading, show_model);
...
function right_customer(){
    $(document).on("mouseenter",".right-customer .small-blue",function () {
        $(this).next().fadeIn();
    });
