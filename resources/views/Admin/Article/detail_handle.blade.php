...
@section('body')
    ...
    <form class="layui-form" action="" lay-filter="edit">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="edit_parent_id" name="ac_id" lay-verify="required">
...
//TODO
  ...
  layedit.set({
      uploadImage: {
        url: '/{{config('sys_conf.admin')}}/api/upload/article' //接口url
        ,type: 'post'
      }
    });
  ...
  form.on('submit(submitBtn)', function(data){
    ...
    ajaxDo(url,type,data.field,function(data){
        if (data['code'] == '1'){
            window.location.href="/{{config('sys_conf.admin')}}/ArticleDetail";
        }else{
            layer.msg(data['msg']);
        }
    });
