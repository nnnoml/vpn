...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        <blockquote class="layui-elem-quote">
            <a href="/{{config('sys_conf.admin')}}/HelpDetail/create"><button type="button" class="layui-btn"><i class="layui-icon layui-icon-add-1"></i> 添加文章</button></a>
        </blockquote>
        ...
        <div class="layui-form">
            <table class="layui-table">
                ...
                <tr a_id="{{$vo['id']}}">
                    ...
                    <td>
                        <a href="/{{config('sys_conf.admin')}}/HelpDetail/{{$vo['id']}}/edit"><button type="button" class="edit layui-btn layui-btn-primary layui-btn-sm"><i class="layui-icon layui-icon-edit"></i>编辑</button></a>
        ...
        $(".del").click(function(){
            ...
            layer.confirm('确认删除？', {
              btn: ['确定','取消'] //按钮
                ...
                var url = '/{{config('sys_conf.admin')}}/HelpDetail/'+ac_id;
